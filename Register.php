              ...
              <div class="widget">
                ...
                <div class="widget-body">
                    ...
                    <div class="control-group success">
                      ...
                      <div class="controls">
                        <input type="text" name="emp_aadhar" id="aadhar" class="span12" placeholder="aadhar number"  />
                      </div>
                    </div>
...
Site Address:
    ...
    <div class="controls">
      <input type="text" name="emp_site_address" id="site_address" class="span12" placeholder="Enter the site address"  />
    </div>
  </div>
                    ...
                    <div ><label for="zip">Pincode</label>
                    ...
                    <div>
                      ...
                      <input type="number" min="100000000" max="9999999999" id="contact" class="span12" name="emp_phn">
                                        ...
                                        <div>
                                          ...
                                          <input type="date" min="" max="" id="contact" class="span12" name="emp_date_joining">


                                        </div>

                                        <div>
                                          <label for="contact"> Date of Leaving  </label>
                                          <input type="date" min="" max="" id="contact" class="span12" name="emp_date_leaving">
