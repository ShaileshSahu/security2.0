...
$emp_site_address = $_POST['emp_site_address'];
$emp_date_joining = $_POST['emp_date_joining'];
$emp_date_leaving = $_POST['emp_date_leaving'];
 ...
 move_uploaded_file($file_tmp,"upload/".$file_name);
  ...
  $query =
  "INSERT INTO `guard_info` (`emp_name`, `emp_father_name`, `emp_dob`, `emp_account_no`, `emp_esic_no`, `emp_pf_no`, `emp_gender`, `emp_designation`, `uan_no`, `emp_address`, `emp_phn`, `emp_image`, `emp_zone`,`emp_police_no`,`emp_aadhar`,`emp_site_address`,`emp_date_joining`,`emp_date_leaving`) VALUES ( '$emp_name', '$emp_father_name', '$emp_dob', $emp_account_no, $emp_esic_no, $emp_pf_no, '$emp_gender', '$emp_designation', $emp_uan_no, '$emp_address', '$emp_phn', '$file_name','$emp_site_name',$emp_police_no,$emp_aadhar,$emp_site_address,'$emp_date_joining','$emp_date_leaving')";
